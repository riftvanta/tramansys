...
export default function Header({ user, onMobileMenuToggle, onSidebarToggle }: HeaderProps) {
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500">
              ...
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5L10 17h5V7a5 5 0 0110 0v10z" />
              </svg>
            </button>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="hidden sm:block text-sm text-gray-600">Online</span>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs text-gray-500">{user.role === 'admin' ? 'Administrator' : 'Exchange'}</p>
                </div>
              </div>
